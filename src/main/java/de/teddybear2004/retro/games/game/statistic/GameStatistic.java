...
public class GameStatistic {
    ...
    public static final NamespacedKey MAP_KEY = new NamespacedKey(RetroGames.getPlugin(RetroGames.class), "map");
    public static final NamespacedKey SEED_KEY = new NamespacedKey(RetroGames.getPlugin(RetroGames.class), "seed");
    public static final NamespacedKey X_KEY = new NamespacedKey(RetroGames.getPlugin(RetroGames.class), "x");
    public static final NamespacedKey Y_KEY = new NamespacedKey(RetroGames.getPlugin(RetroGames.class), "y");
